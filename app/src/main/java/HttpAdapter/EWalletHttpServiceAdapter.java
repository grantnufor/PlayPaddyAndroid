...
public class EWalletHttpServiceAdapter {



    public ArrayList<JSONObject> GetAllEwallets()
    {
        String SOAP_ACTION_GetJsonData ="http://tempuri.org/GetAllEwallets";
        String OPERATION_NAME_GetJsonData = "GetAllEwallets";
    ...
    public JSONObject GetEwalletByEwalletId(String ewalletId)
    {

        String SOAP_ACTION_GetJsonData ="http://tempuri.org/GetEwalletByEwalletId";
...
//            }
    ...
    public JSONObject GetEwalletByUserId(String userId)
    {

        String SOAP_ACTION_GetJsonData ="http://tempuri.org/GetEwalletByUserId";
...
//            }
    ...
    public String AddEwallet(String userId, String referralBonus, String amountForSale, String currentBalance, String otp, String dateCreated, String dateLastModified)
    {
        ...
        try
        {
            SoapObject request = new SoapObject(WSDL_TARGET_NAMESPACE,OPERATION_NAME_GetJsonData);
            request.addProperty("userId", userId);
            request.addProperty("referralBonus", referralBonus);
            request.addProperty("amountForSale", amountForSale);
