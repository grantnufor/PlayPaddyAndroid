...
public class UserBankHttpServiceAdapter {
    ...
    public ArrayList<JSONObject> GetAllUserBanks()
    {
        ...
        String OPERATION_NAME_GetJsonData = "GetAllUserBanks";
    ...
    public JSONObject GetUserBankByUserBankId(String userBankId)
    {

        String SOAP_ACTION_GetJsonData ="http://tempuri.org/GetUserBankByUserBankId";
        ...
        {
            SoapObject request = new SoapObject(WSDL_TARGET_NAMESPACE,OPERATION_NAME_GetJsonData);
            request.addProperty("userBankId", userBankId);
            SoapSerializationEnvelope envelope = new SoapSerializationEnvelope(SoapEnvelope.VER11);
            envelope.dotNet = true;
            envelope.setOutputSoapObject(request);
            HttpTransportSE httpTransport = new HttpTransportSE(SOAP_ADDRESS);
...
//            }
    ...
    public JSONObject GetUserBankByUserId(String userId)
    {

        String SOAP_ACTION_GetJsonData ="http://tempuri.org/GetUserBankByUserId";
...
//            }
    ...
    public String AddUserBank(String bankName, String accountName, String accountNo, String sortCode, String dateAdded,
                              String dateLastUpdated, String userId)
    {
        String SOAP_ACTION_GetJsonData ="http://tempuri.org/AddUserBank";
        String OPERATION_NAME_GetJsonData = "AddUserBank";
...
//            }
    ...
    public String UpdateUserBank(String userBankId, String bankName, String accountName, String accountNo, String sortCode, String dateAdded,
                                 String dateLastUpdated, String userId)
    {
